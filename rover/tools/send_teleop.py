...
from rover.rover_ports import HOST, TELEOP_PORT
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Send teleop command")
    parser.add_argument("--host", default=HOST)
    parser.add_argument("--port", type=int, default=TELEOP_PORT)
